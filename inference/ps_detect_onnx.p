...
if __name__ == '__main__':
    ...
    model_path = './onnx/yolov7_n_tda2_ps_32st_20221117_grid_sim.onnx'
    session = onnxruntime.InferenceSession(model_path)
    # img_dir = '/rd22857/dataset/parkingslot_lh/images_test/1'
    img_dir = './dataset/test_221128'# '/dataset/parking_slot_lh/raw/images/20221110131516'

    if 0: # Test
        main('./', img_path, session, inMean, inScale, './output_single')

    if 1:# batch test
        outPath = './output_test_20221128'
        check_dir(outPath)
